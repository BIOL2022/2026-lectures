...
- $\text{body mass} \sim \textcolor{blue}{\text{flipper length}} + \textcolor{blue}{\text{bill depth}}$, all continuous
- $\text{body mass} \sim \textcolor{blue}{\text{flipper length}} + \textcolor{orange}{\text{species}}$, at *least* one continuous, one categorical
- $\text{body mass} \sim \textcolor{orange}{\text{sex}} + \textcolor{orange}{\text{species}}$, all categorical
...
$$\text{body mass} \sim \textcolor{blue}{\text{flipper length}} + \textcolor{blue}{\text{bill depth}}$$
...
$$ \text{body mass} \sim \textcolor{blue}{\text{flipper length}} $$
...
$$ \text{body mass} \sim \textcolor{blue}{\text{flipper length}} \times \textcolor{blue}{\text{bill depth}}$$

which is also equivalent to:
$$ \text{body mass} \sim \textcolor{blue}{\text{flipper length}} + \textcolor{blue}{\text{bill depth}} + \textcolor{red}{\text{flipper length:bill depth}}$$
::::
