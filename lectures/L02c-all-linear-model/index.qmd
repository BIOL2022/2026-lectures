...
- [ ] Understand why we focus on modelling relationships between variables (we try not to use the hypothesis testing framework)
- [ ] Recognise that most common statistical tests can be expressed as a general linear model (GLM)
- [ ] While not all statistical tests are GLMs, the GLM framework is a useful way to think about relationships between variables and how to model them.
