...
<div class="resource-links">
  ...
  <a class="resource-link" href="https://canvas.sydney.edu.au/courses/74353/pages/unit-outline" target="_blank" rel="noopener">
...
- Create `tofu`, our jamovi module for **multivariate analysis**
- Organise the automated schedule in the handbook and the canvas front page
...
- write any practical, lecture or assessment content (including exams). This is my (Januar) stance for BEDA and I stand by it.
- mark your assessments (all our 12 demonstrators will be full hands on deck for marking)
- check your assessments for plagiarism (AI checking AI... not a smart move)
...
Be prepared to be **interviewed**. We will also use the practicals to audit your progress, as 60% of the practicals involve you collecting and analysing your own data.
...
Both are proprietary and require a licence.



## I am a beginner, which should I use?
...
- Use **R** only if you have prior experience. It takes many weeks to learn, but it is the most powerful and flexible option.
