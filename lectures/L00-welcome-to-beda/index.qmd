...
<style>
.spotlight{position:relative;height:460px;}
.spotlight .quote{position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:0 80px;background:#fff;}
.spotlight .quote .mark{font-size:84px;color:#e64626;line-height:.5;font-family:Georgia,serif;}
.spotlight .quote p{font-size:30px;line-height:1.35;font-style:italic;color:#1f1f24;max-width:760px;margin:10px 0 0;}
.spotlight .quote p strong{font-style:normal;}
</style>
...
fmt <- function(x, i) {
  ...
  sprintf('<div class="%s"><span class="mark">&ldquo;</span><p>%s</p></div>', cls, x)
}
