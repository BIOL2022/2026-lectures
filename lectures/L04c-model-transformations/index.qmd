...
$$ y \sim x_1 + x_2 + \ldots + x_n \rightarrow \color{blue} f(y) \sim x_1 + x_2 + \ldots + x_n $$
...
This presentation is based on the [SOLES Quarto reveal.js template](https://github.com/usyd-soles-edu/soles-revealjs) and is licensed under a [Creative Commons Attribution 4.0 International License][cc-by]. A pdf version of this document can be found [here](L04c-model-transformations.pdf).
