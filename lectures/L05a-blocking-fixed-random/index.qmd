...
$$ \text{species diversity} \sim \textcolor{red}{\text{lake size}} + \textcolor{black}{\text{species diversity}} $$
...
::: fragment
$$ \text{kangaroo abundance} \sim \textcolor{red}{\text{error(time of day)}} + \text{habitat} $$
...
$$
\text{response} = \beta_0 + \textcolor{red}{b \cdot \text{block}} + \beta_1\,\text{treatment} + \epsilon \\
...
$$ \text{body mass} \sim \textcolor{red}{\text{error(flipper length)}} + \textcolor{blue}{\text{bill length}} $$
...
$$ \text{body mass} \sim \textcolor{blue}{\text{error(bill length)}} + \textcolor{orange}{\text{species}} $$
