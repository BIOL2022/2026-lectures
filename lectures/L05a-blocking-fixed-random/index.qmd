...
$$
\text{body mass} \sim \color{blue}{\text{bill length}} + \color{blue}{\text{flipper length}}
$$
...
$$ \text{body mass} \sim \color{orange}{\text{species}} \color{black}+ \color{orange}{\text{sex}} $$
...
#| cache: true
#| fig-height: 4
# emmeans(fit02, pairwise ~ species)$contrasts |>
#   as_tibble() %>%
#   # round all cells to 3 decimal places
...
$$ \text{body mass} \sim \color{blue}{\text{bill length}} \color{black}+ \color{orange}{\text{species}} $$
...
$$ \text{species diversity} \sim \color{red}{\text{lake size}} + \color{black}{\text{species diversity}} $$
...
$$ \text{body mass} \sim \color{red}{\text{sex}} + \color{black}\text{species} $$
...
$$ \text{kangaroo abundance} \sim \color{red}{\text{time of day}} + \color{black}\text{habitat} $$
...
$$ \text{plant growth} \sim \color{red}{\text{worker}} + \color{black}\text{fertiliser} $$
...
$$ \text{pig growth} \sim \color{red}{\text{farm}} + \color{black}\text{feed} $$
...
$$ \text{body mass} \sim \color{red}{\text{island}} + \color{black}\text{species} $$
```{r}
...
::: fragment
$$ \text{kangaroo abundance} \sim \color{red}{\text{time of day}} + \text{habitat} $$

$$becomes$$
:::

::: fragment
$$ \text{kangaroo abundance} \sim \color{red}{\text{error(time of day)}} + \text{habitat} $$
...
::: fragment
$$ \text{response} \sim \color{red}{\text{(1|block)}} + \text{treatment} $$
...
$$
\text{response} = \beta_0 + \color{red}{b \cdot \text{block}} + \beta_1\,\text{treatment} + \epsilon \\
\textcolor{black}{\text{where}\ b \sim \mathcal{N}(0, \sigma^2_b)}
$$
...
$$ \text{body mass} \sim \color{red}{\text{error(flipper length)}} + \color{blue}{\text{bill length}} $$
...
$$ \text{body mass} \sim \color{red}{\text{island}} + \color{orange}{\text{species}} $$
...
### When both predictors are [CONTINUOUS]{style="color:blue"} and [CATEGORICAL]{style="color:orange"} but one is a BLOCK

::: fragment
$$ \text{body mass} \sim \color{red}{\text{species}} + \color{blue}{\text{bill length}} $$
...
### When both predictors are [CONTINUOUS]{style="color:blue"} and [CATEGORICAL]{style="color:orange"} but one is a COVARIATE

::: fragment

$$ \text{body mass} \sim \color{blue}{\text{error(bill length)}} + \color{orange}{\text{species}} $$
...
This presentation is based on the [SOLES Quarto reveal.js template](https://github.com/usyd-soles-edu/soles-revealjs) and is licensed under a [Creative Commons Attribution 4.0 International License][cc-by]. A pdf version of this document can be found [here](L05a-blocking-fixed-random.pdf).
